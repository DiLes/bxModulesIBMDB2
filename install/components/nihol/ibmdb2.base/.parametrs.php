...
$arComponentParameters = array(
    ...
    "PARAMETERS" => array(
        "NIHOL_IBMDB2_BASE" => array(
            "PARENT" => "BASE",
            "NAME" => Loc::getMessage("NIHOL_IBMDB2_BASE"),
            "DEFAULT" => '={$_REQUEST["ID"]}',
        ),
        "AJAX_MODE" => array(),
        "IBLOCK_TYPE" => array(
        ...
        "DETAIL_URL" => CIBlockParameters::GetPathTemplateParam(
            "DETAIL",
            "DETAIL_URL",
            Loc::GetMessage("T_IBLOCK_DESC_DETAIL_PAGE_URL"),
            "",
            "URL_TEMPLATES"
        ),
        ...
        "ACTIVE_DATE_FORMAT" => CIBlockParameters::GetDateFormat(Loc::GetMessage("T_IBLOCK_DESC_ACTIVE_DATE_FORMAT"), "ADDITIONAL_SETTINGS"),
        "SET_TITLE" => array(),
        "SET_BROWSER_TITLE" => array(
            "PARENT" => "ADDITIONAL_SETTINGS",
            "NAME" => Loc::GetMessage("CP_BNL_SET_BROWSER_TITLE"),
            "TYPE" => "CHECKBOX",
            "DEFAULT" => "Y",
        ),
        "SET_META_KEYWORDS" => array(
            "PARENT" => "ADDITIONAL_SETTINGS",
            "NAME" => Loc::GetMessage("CP_BNL_SET_META_KEYWORDS"),
            "TYPE" => "CHECKBOX",
            "DEFAULT" => "Y",
        ),
        "SET_META_DESCRIPTION" => array(
            "PARENT" => "ADDITIONAL_SETTINGS",
            "NAME" => Loc::GetMessage("CP_BNL_SET_META_DESCRIPTION"),
            "TYPE" => "CHECKBOX",
            "DEFAULT" => "Y",
        ),
        ...
        "INCLUDE_IBLOCK_INTO_CHAIN" => array(
            "PARENT" => "ADDITIONAL_SETTINGS",
            "NAME" => Loc::GetMessage("T_IBLOCK_DESC_INCLUDE_IBLOCK_INTO_CHAIN"),
            "TYPE" => "CHECKBOX",
            "DEFAULT" => "Y",
        ),
        "ADD_SECTIONS_CHAIN" => array(
            "PARENT" => "ADDITIONAL_SETTINGS",
            "NAME" => Loc::GetMessage("T_IBLOCK_DESC_ADD_SECTIONS_CHAIN"),
            "TYPE" => "CHECKBOX",
            "DEFAULT" => "Y",
        ),
        ...
        "PARENT_SECTION_CODE" => array(
            "PARENT" => "ADDITIONAL_SETTINGS",
            "NAME" => Loc::GetMessage("IBLOCK_SECTION_CODE"),
            "TYPE" => "STRING",
            "DEFAULT" => '',
        ),
        "INCLUDE_SUBSECTIONS" => array(
            "PARENT" => "ADDITIONAL_SETTINGS",
            "NAME" => Loc::GetMessage("CP_BNL_INCLUDE_SUBSECTIONS"),
            "TYPE" => "CHECKBOX",
            "DEFAULT" => "Y",
        ),
        "STRICT_SECTION_CHECK" => array(
            "PARENT" => "ADDITIONAL_SETTINGS",
            "NAME" => Loc::GetMessage("CP_BNL_STRICT_SECTION_CHECK"),
            "TYPE" => "CHECKBOX",
            "DEFAULT" => "N",
        ),
