...
$MESS ['PROPERTY_FOR_FILE'] = "Свойство для получения файла";
$MESS ['SHOW_DEPARTMENT'] = "Выводить отдел";
$MESS ['SHOW_FILE_SIZE'] = "Показать размер файла";
$MESS ['SHOW_FILE_TYPE'] = "Показать тип файла";
$MESS ['SHOW_FILE_UPDATE'] = "Показать дату обновления";
?>