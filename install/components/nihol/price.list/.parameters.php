...
$arComponentParameters = array(
	...
	"PARAMETERS"  =>  array(
		...
		"PROPERTY_FOR_FILE"  =>  Array(
			"PARENT" => "ADDITIONAL_SETTINGS",
			"NAME" => GetMessage("PROPERTY_FOR_FILE"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "Y",
			"VALUES" => $arSortFields,
			//"ADDITIONAL_VALUES" => "Y",
		...
		"SHOW_DEPARTMENT"  =>  Array(
			"PARENT" => "ADDITIONAL_SETTINGS",
			"NAME" => GetMessage("SHOW_DEPARTMENT"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "Y",
		),
		"SHOW_FILE_SIZE"  =>  Array(
			"PARENT" => "ADDITIONAL_SETTINGS",
			"NAME" => GetMessage("SHOW_FILE_SIZE"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "Y",
		),
		"SHOW_FILE_TYPE"  =>  Array(
			"PARENT" => "ADDITIONAL_SETTINGS",
			"NAME" => GetMessage("SHOW_FILE_TYPE"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "Y",
		),
		"SHOW_FILE_UPDATE"  =>  Array(
			"PARENT" => "ADDITIONAL_SETTINGS",
			"NAME" => GetMessage("SHOW_FILE_UPDATE"),
			"TYPE" => "CHECKBOX",
			"DEFAULT" => "Y",
		),
	),
